...
VariableList var = pdata.getVariableList();
...
try {
    ...
    "and a.pName like '%"+ search + "%'";
    System.out.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1"+search);
    rs = stmt.executeQuery(SQL);

    /********* Dataset Create ************/
    DataSet ds = new DataSet("productds");
    ...
    ds.addColumn("price",DataTypes.STRING, 255);
    ...
    while(rs.next())
    {
        ...
        ds.set(row, "price", rs.getString("price"));
